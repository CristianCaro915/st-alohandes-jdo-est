...
class SQLHostal {
    ...
    public long adicionarHostal(PersistenceManager pm, BigDecimal ID_HS, String NOMBRE, BigDecimal RECEPCION, Timestamp HORACIERRE,Timestamp HORAAPERTURA,String TIPO) {
